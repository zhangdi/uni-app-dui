<template>
    <view class="fa" :class="[ 'fa-' + type, { 'fa-fw' : isMargin } ]" :style="{'color': color, 'font-size': fontSize,'width': width,'heigth':height}"
        @click="onClick"></view>
</template>
...
<script>
    export default {
        ...
        computed: {
            ...
            isMargin() {
                return String(this.margin) == 'true'
            },
            width() {
                if (typeof(this.size) == 'number') {
                    return this.size + 'rpx';
